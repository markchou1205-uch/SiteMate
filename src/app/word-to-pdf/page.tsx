...
const translations = {
  en: {
    ...
    startTitle: 'Upload Word Files to Convert to PDF',
    startDescription: 'Select one or more Word files (.doc, .docx) to begin.',
  ...
  zh: {
    ...
    startDescription: '選擇一個或多個 Word 檔案（.doc, .docx）以開始。',
