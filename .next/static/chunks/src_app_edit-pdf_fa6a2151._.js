                    ...
                    fabricCanvas.on("mouse:down", {
                        "PdfCanvas.useEffect.renderPage": (e)=>{
                            if (toolMode === "text" && e.pointer) {
                                const text = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Textbox"]("輸入文字", {
                                    left: e.pointer.x,
                                    top: e.pointer.y,
                                    fontSize: 16,
                                    fill: color
...
//# sourceMappingURL=src_app_edit-pdf_fa6a2151._.js.map