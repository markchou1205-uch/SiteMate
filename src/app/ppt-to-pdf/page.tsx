...
const translations = {
  en: {
    ...
    startTitle: 'Upload PowerPoint Files to Convert to PDF',
    startDescription: 'Select one or more PowerPoint files (.ppt, .pptx) to begin.',
  ...
  zh: {
    ...
    startDescription: '選擇一個或多個 PowerPoint 檔案（.ppt, .pptx）以開始。',
...
const FilePreview = ({ file, onRemove }: { file: File, onRemove: (fileName: string) => void }) => (
    <div className="flex items-center gap-2 p-2 border rounded-md text-sm bg-muted/50">
        <LucidePresentation className="h-5 w-5 text-primary flex-shrink-0" />
