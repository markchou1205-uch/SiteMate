...
;
;
const PageThumbnailList = ({ thumbnails, currentPage, onPageClick, onAddBlankPage, onDeletePage, onRotatePage, onReorderPages })=>{
    _s();
...
_s(PageThumbnailList, "GhlL2CtjIl6FkKEl4YdoqujQXFE=");
...
function Page() {
    ...
    const handleRotateActivePage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[handleRotateActivePage]": (direction)=>{
            if (!pdfDoc || currentPage < 1) return;
            const pageIndex = currentPage - 1;
            const rotate = {
                "Page.useCallback[handleRotateActivePage].rotate": async ()=>{
                    ...
                    setPdfDoc(newDoc);
                    setDocVersion({
                        "Page.useCallback[handleRotateActivePage].rotate": (v)=>v + 1
                    }["Page.useCallback[handleRotateActivePage].rotate"]);
                }
            }["Page.useCallback[handleRotateActivePage].rotate"];
            rotate();
        }
    ...
    const onDeletePage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[onDeletePage]": async (index)=>{
            ...
            setPdfDoc(newDoc);
            setDocVersion({
                "Page.useCallback[onDeletePage]": (v)=>v + 1
...
_s(Page, "VFxq17Ecc3IurNTKMlJY50f1YEM=", false, function() {
    return [
...
//# sourceMappingURL=src_8b9a771d._.js.map