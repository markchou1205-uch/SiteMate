            ...
            <div className="w-full max-w-4xl space-y-8">
                <Card className="w-full">
                  <CardHeader className="text-center">
                      ...
                      <CardTitle>{texts.jpgToPdfTitle}</CardTitle>
                      <CardDescription>{texts.jpgToPdfDescription}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <Button type="submit" className="w-full" disabled={!selectedFile || !isLoggedIn}>
