...
const translations = {
  en: {
    ...
    startTitle: 'Upload Image File to Convert to PDF',
    startDescription: 'Select an image file to begin.',
    uploadButton: 'Click or drag an image file here',
...
export default function JpgToPdfPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isLoggedIn === false) {
      toast({title: texts.featureNotAvailable, description: texts.featureNotAvailableForGuests});
      return;
    }
              ...
              <Card className="w-full">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full" disabled={isLoading || !selectedFile || !isLoggedIn}>
