...
import { Upload, Scissors, Download, LogIn, LogOut, UserCircle, ArrowRightLeft, Edit, FileUp, ListOrdered, Combine, FileText, FileSpreadsheet, LucidePresentation, Code, FileImage, FileMinus, Droplets, ScanText, Sparkles, ShieldCheck } from 'lucide-react';
...
export default function PdfToPdfaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const endpoint = `https://pdfsolution.dpdns.org/api/pdf-to-pdfa?pdfa_version=${pdfaVersion}&embed_fonts=true&remove_transparency=true`;
          ...
          return (
              <Card className="max-w-2xl w-full mx-auto">
                <CardHeader className="text-center">
                    ...
                    <CardTitle>{texts.pdfToPdfaTitle}</CardTitle>
                    <CardDescription>{texts.pdfToPdfaDescription}</CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="pdfa-version">{texts.pdfaVersion}</Label>
                      <Select value={pdfaVersion} onValueChange={setPdfaVersion}>
                          <SelectTrigger id="pdfa-version" className="w-full">
                              <SelectValue placeholder={texts.selectVersion} />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="1">PDF/A-1</SelectItem>
                            <SelectItem value="2">PDF/A-2</SelectItem>
                            <SelectItem value="3">PDF/A-3</SelectItem>
                          </SelectContent>
                      </Select>
                    </div>
                        ...
                        <MenubarContent>
                            ...
                            <MenubarSub>
                                ...
                                <MenubarSubContent>
                                    ...
                                    <MenubarItem onClick={() => router.push('/pdf-to-pdfa')} disabled><ShieldCheck className="mr-2 h-4 w-4" />{texts.pdfToPdfaTitle}</MenubarItem>
                                </MenubarSubContent>
                            </MenubarSub>
                        </MenubarContent>
                    </MenubarMenu>
