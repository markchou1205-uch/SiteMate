...
const translations = {
  en: {
    ...
    pageDescription: 'Convert your HTML files into standard PDF files.',
    startTitle: 'Upload HTML Files to Convert to PDF',
    startDescription: 'Select one or more HTML files (.html, .htm) to begin.',
    ...
    invalidFileErrorDesc: (filename: string) => `File "${filename}" is not a valid HTML document.`,
  ...
  zh: {
    ...
    pageDescription: '將您的 HTML 文件轉換為標準的 PDF 檔案。',
    startTitle: '上傳 HTML 檔案以轉換為 PDF',
    startDescription: '選擇一個或多個 HTML 檔案（.html, .htm）以開始。',
    ...
    invalidFileErrorDesc: (filename: string) => `檔案 "${filename}" 不是有效的 HTML 文件。`,
    proMode: '專業模式',
    cancel: '取消',
    confirm: '確認',
                        ...
                        <MenubarContent>
                            <MenubarSub>
                                ...
                                <MenubarSubContent>
                                    ...
                                    <MenubarItem onClick={() => router.push('/html-to-pdf')} disabled><Code className="mr-2 h-4 w-4" />{texts.htmlToPdf}</MenubarItem>
