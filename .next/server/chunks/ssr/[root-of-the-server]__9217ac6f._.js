    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$toggle$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Toggle"], {
                ...
                onPressedChange: (pressed)=>onAnnotationChange(annotation.id, {
                        bold: pressed
                    }),
...
const TextAnnotationComponent = ({ annotation, mainCanvasZoom, isSelected, isEditing, onAnnotationChange, onSelect, onEdit, onDragStart, onResizeStart })=>{
...
function PdfEditorPage() {
    ...
    const drawingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const scribblePointsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])([]);
    ...
    const handleDragMouseDown = (event, type, id)=>{
        ...
        switch(itemType){
            ...
            case 'mosaic':
                ...
                break;
            case 'scribble':
                initialItemState = scribbleAnnotations.find((a)=>a.id === id);
                break;
        }
            ...
            if (isResize) {
                ...
                switch(itemType){
                    ...
                    case 'scribble':
                        ...
                        const updatedItems = items.map((ann)=>ann.id === id ? {
                                ...ann,
                                widthRatio: newWidthRatio,
                                heightRatio: newWidthRatio / ann.aspectRatio * (containerRect.width / containerRect.height)
                            } : ann);
                        tempStateRef = itemType === 'image' ? {
                            imageAnnotations: updatedItems
                        } : {
                            scribbleAnnotations: updatedItems
                        };
                        break;
                    case 'highlight':
                    case 'shape':
                    case 'mosaic':
                        ...
                        const updatedShapeItems = itemsToUpdate.map((ann)=>ann.id === id ? {
                                ...ann,
                                widthRatio: newWidthRatio,
                                heightRatio: newHeightRatio
                            } : ann);
                        tempStateRef = itemType === 'highlight' ? {
                            highlightAnnotations: updatedShapeItems
                        } : itemType === 'shape' ? {
                            shapeAnnotations: updatedShapeItems
                        } : {
                            mosaicAnnotations: updatedShapeItems
                        };
                        break;
                    case 'text':
                        newWidthRatio = Math.max(0.1, newWidthPx / containerRect.width);
                        tempStateRef = {
                            textAnnotations: textAnnotations.map((ann)=>ann.id === id ? {
                                    ...ann,
                                    widthRatio: newWidthRatio
                                } : ann)
                        };
                ...
                const updater = (prev)=>prev.map((ann)=>ann.id === id ? {
                            ...ann,
                ...
                switch(itemType){
                    case 'text':
                        tempStateRef = {
                            textAnnotations: updater(textAnnotations)
                        };
                        break;
                    case 'image':
                        tempStateRef = {
                            imageAnnotations: updater(imageAnnotations)
                        };
                        break;
                    case 'highlight':
                        tempStateRef = {
                            highlightAnnotations: updater(highlightAnnotations)
                        };
                        break;
                    case 'shape':
                        tempStateRef = {
                            shapeAnnotations: updater(shapeAnnotations)
                        };
                        break;
                    case 'mosaic':
                        tempStateRef = {
                            mosaicAnnotations: updater(mosaicAnnotations)
                        };
                        break;
                    case 'scribble':
                        tempStateRef = {
                            scribbleAnnotations: updater(scribbleAnnotations)
                        };
                        break;
                }
            }
    ...
    const handleAnnotationChange = (id, updates)=>{
        ...
        if (annotationType === 'text') {
            const newAnnotations = textAnnotations.map((ann)=>ann.id === id ? {
                    ...ann,
                    ...updates
                } : ann);
            updateState({
                textAnnotations: newAnnotations
            }, false);
        } else if (annotationType === 'shape') {
            const newAnnotations = shapeAnnotations.map((ann)=>ann.id === id ? {
                    ...ann,
                    ...updates
                } : ann);
            updateState({
                shapeAnnotations: newAnnotations
            }, false);
        }
    };
    const handleAnnotationChangeEnd = (id, updates)=>{
        const annotationType = selectedObject?.type;
        if (annotationType === 'text') {
            const newAnnotations = textAnnotations.map((ann)=>ann.id === id ? {
                    ...ann,
    ...
    const handleSelectAnnotation = (type, id)=>{
        setSelectedObject({
            type,
            id
        });
    ...
    const handleTextAnnotationDoubleClick = (id)=>{
        setSelectedObject({
            type: 'text',
            id: id
        });
    ...
    const handleSaveLink = ()=>{
        ...
        if (selectedObject.type === 'text') {
            updateState({
                textAnnotations: textAnnotations.map((ann)=>ann.id === selectedObject.id ? {
                        ...ann,
                        link: currentLink
                    } : ann)
            });
            ...
            updateState({
                imageAnnotations: imageAnnotations.map((ann)=>ann.id === selectedObject.id ? {
                        ...ann,
                        link: currentLink
                    } : ann)
            });
    ...
    const editingTextAnnotation = interactionMode === 'editing' && selectedObject?.type === 'text' ? textAnnotations.find((a)=>a.id === selectedObject.id) : null;
    const selectedShapeAnnotation = interactionMode === 'selected' && selectedObject?.type === 'shape' ? shapeAnnotations.find((a)=>a.id === selectedObject.id) : null;
    ...
    const handlePageMouseMove = (e)=>{
        ...
        if (activeTool === 'mosaic') {
            const newAnnotations = mosaicAnnotations.map((ann)=>ann.id === id ? {
                    ...ann,
                    leftRatio,
                    topRatio,
                    widthRatio,
            ...
            updateState({
                mosaicAnnotations: newAnnotations
            }, false);
        }
    };
    const handlePageMouseUp = ()=>{
        ...
        if (activeTool === 'mosaic') {
            ...
            if (finalAnnotation && (finalAnnotation.widthRatio > 0.01 || finalAnnotation.heightRatio > 0.01)) {
                updateState({
                    mosaicAnnotations: editorState.mosaicAnnotations
                }, true);
            } else {
                updateState({
                    mosaicAnnotations: editorState.mosaicAnnotations.filter((a)=>a.id !== id)
                }, false);
            }
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MenubarSubContent"], {
                                                    children: saveAsFormatOptions.map((opt)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$menubar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MenubarItem"], {
                                                            onClick: ()=>handleSaveAsFormat(opt.value),
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Tooltip"], {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tooltip$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TooltipContent"], {
                                                    side: "bottom",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        children: texts.downloadEditedFile
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/edit-pdf/page.tsx",
                                                        lineNumber: 2987,
                                                        columnNumber: 55
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    editingTextAnnotation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(TextAnnotationToolbar, {
                    ...
                    selectedShapeAnnotation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ShapeToolbar, {
                    ...
                    pageObjects.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ref: mainViewContainerRef,
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("flex-grow bg-muted/30 overflow-auto flex flex-col items-center p-4 space-y-4 relative", activeTool === 'pan' && 'cursor-grab', activeTool === 'mosaic' && 'cursor-crosshair'),
                                        ...
                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                highlightAnnotations.filter((ann)=>ann.pageIndex === index).map((ann)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        onClick: (e)=>{
                                                            e.stopPropagation();
                                                            handleSelectAnnotation('highlight', ann.id);
                                                        },
                                                ...
                                                mosaicAnnotations.filter((ann)=>ann.pageIndex === index).map((ann)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        onClick: (e)=>{
                                                            e.stopPropagation();
                                                            handleSelectAnnotation('mosaic', ann.id);
                                                        },
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("absolute cursor-grab", selectedObject?.id === ann.id && "border-2 border-dashed border-primary"),
                                                        style: {
                                                            left: `${ann.leftRatio * 100}%`,
                                                ...
                                                imageAnnotations.filter((ann)=>ann.pageIndex === index).map((ann)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        onClick: (e)=>{
                                                            e.stopPropagation();
                                                            handleSelectAnnotation('image', ann.id);
                                                        },
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("absolute cursor-grab", selectedObject?.id === ann.id && "border-2 border-dashed border-primary"),
                                                        style: {
                                                            left: `${ann.leftRatio * 100}%`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9217ac6f._.js.map