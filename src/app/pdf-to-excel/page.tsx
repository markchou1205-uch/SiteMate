          ...
          return (
              <Card className="max-w-2xl w-full mx-auto">
                <CardHeader className="text-center">
                    ...
                    <CardTitle>{texts.pdfToExcelTitle}</CardTitle>
                    <CardDescription>{texts.pdfToExcelDescription}</CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <MenubarContent>
                            <MenubarSub>
                                ...
                                <MenubarSubContent>
                                    ...
                                    <MenubarItem onClick={() => router.push('/jpg-to-pdf')}><FileImage className="mr-2 h-4 w-4" />{texts.jpgToPdfTitle}</MenubarItem>
                                </MenubarSubContent>
                            </MenubarSub>
                            <MenubarSub>
                                ...
                                <MenubarSubContent>
                                    ...
                                    <MenubarItem onClick={() => router.push('/pdf-to-excel')} disabled><FileSpreadsheet className="mr-2 h-4 w-4" />{texts.pdfToExcelTitle}</MenubarItem>
