...
export default function WordToPdfPage() {
  ...
  const resetPage = () => {
    ...
    // Also reset batch conversion state
    setBatchFiles([]);
    setUploadStatuses({});
            ...
            return (
                <div className="w-full max-w-4xl space-y-8">
                    ...
                    <CardHeader className="text-center">
                        ...
                        <CardTitle>{texts.wordToPdfTitle}</CardTitle>
                        <CardDescription>{texts.wordToPdfDescription}</CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <MenubarMenu>
                        ...
                        <MenubarContent>
                            <MenubarSub>
                                ...
                                <MenubarSubContent>
                                    <MenubarItem onClick={() => router.push('/word-to-pdf')} disabled><FileText className="mr-2 h-4 w-4" />{texts.wordToPdfTitle}</MenubarItem>
