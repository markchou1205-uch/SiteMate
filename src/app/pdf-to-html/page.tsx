            ...
            return (
              <Card className="max-w-2xl w-full mx-auto">
                <CardHeader className="text-center">
                    ...
                    <CardTitle>{texts.pdfToHtmlTitle}</CardTitle>
                    <CardDescription>{texts.pdfToHtmlDescription}</CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <MenubarContent>
                            ...
                            <MenubarSub>
                                ...
                                <MenubarSubContent>
                                    ...
                                    <MenubarItem onClick={() => router.push('/pdf-to-html')} disabled><Code className="mr-2 h-4 w-4" />{texts.pdfToHtmlTitle}</MenubarItem>
