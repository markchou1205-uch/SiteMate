...
function Page() {
    ...
    const handleAddBlankPage = async (pageIndex)=>{
        ...
        const helveticaFont = await pdfDoc.embedFont(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$StandardFonts$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StandardFonts"].Helvetica);
    ...
    const handleRotatePage = async (pageIndex)=>{
        ...
        page.setRotation((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$rotations$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["degrees"])(newAngle));
        setDocVersion((v)=>v + 1);
        toast({
            title: "Page Rotated",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59d52d7f._.js.map