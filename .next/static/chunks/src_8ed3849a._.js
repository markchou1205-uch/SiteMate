...
"[project]/src/hooks/useTextTool.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useTextTool(canvasRef) {
    _s();
    const selectedColorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])('black');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useTextTool.useEffect": ()=>{
            const canvas = canvasRef.current;
            if (!canvas) return;
            const onMouseDown = {
                "useTextTool.useEffect.onMouseDown": (e)=>{
                    if (!e.target) {
                        canvas.discardActiveObject();
                        canvas.renderAll();
                    }
                }
            }["useTextTool.useEffect.onMouseDown"];
            const onSelectionCleared = {
                "useTextTool.useEffect.onSelectionCleared": ()=>{
                    hideToolbar();
                }
            }["useTextTool.useEffect.onSelectionCleared"];
            const onSelectionCreated = {
                "useTextTool.useEffect.onSelectionCreated": (e)=>{
                    if (e.selected && e.selected[0].type === 'i-text') {
                        showToolbar();
                    }
                }
            }["useTextTool.useEffect.onSelectionCreated"];
            const onObjectModified = {
                "useTextTool.useEffect.onObjectModified": ()=>{
...
_s(useTextTool, "YpTvFpcLXniWGN1tHetDYOKfSEs=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTextTool$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useTextTool.ts [app-client] (ecmascript)");
...
function PdfEditorPage() {
    ...
    const textTool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTextTool$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(fabricCanvasRef);
    const initFabricCanvas = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PdfEditorPage.useCallback[initFabricCanvas]": ()=>{
            ...
            if (container) {
                const newCanvas = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fabric$2f$dist$2f$fabric$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fabric"].Canvas(canvasElement, {
    ...
    const displayPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PdfEditorPage.useCallback[displayPage]": (pageIndex)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fabric$2f$dist$2f$fabric$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fabric"].Image.fromURL(dataUrl, {
                "PdfEditorPage.useCallback[displayPage]": (img)=>{
                    canvas.setBackgroundImage(img, canvas.renderAll.bind(canvas), {
                        scaleX: canvas.width / img.width,
                        scaleY: canvas.height / img.height
                    });
                }
            }["PdfEditorPage.useCallback[displayPage]"]);
    ...
    const handlePdfUpload = async (event)=>{
        ...
        try {
            ...
            const pdfDocProxy = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfjs$2d$dist$2f$build$2f$pdf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocument"])(arrayBuffer).promise;
...
_s(PdfEditorPage, "DFPpyoWaWNQ3NLxtNaJylm4Cmnk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useTextTool$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
_c = PdfEditorPage;
var _c;
...
//# sourceMappingURL=src_8ed3849a._.js.map