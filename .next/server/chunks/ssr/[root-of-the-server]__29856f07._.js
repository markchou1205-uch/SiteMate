...
const translations = {
    en: {
        ...
        zoomDialogDescription: 'View a larger preview of the selected page. You can rotate the page or add temporary notes here. Use mouse wheel to zoom.',
    ...
    zh: {
        ...
        zoomDialogDescription: '查看所選頁面的放大預覽。您可以在此旋轉頁面或新增臨時筆記。使用滑鼠滾輪縮放。',
        bottomLeft: '左下',
        bottomCenter: '中下',
        bottomRight: '右下',
        topLeft: '左上',
...
function PdfEditorHomepage() {
    ...
    const [selectedPages, setSelectedPages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Set());
    ...
    const [watermarkText, setWatermarkText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [isZoomModalOpen, setIsZoomModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        console.log("[Page.tsx useEffect] Imported firebaseApp from '@/lib/firebase':", __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["app"] ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["app"].constructor.name : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["app"]);
        console.log("[Page.tsx useEffect] Imported storage from '@/lib/firebase':", __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"] ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"].constructor.name : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"]);
        console.log("[Page.tsx useEffect] Imported firebaseFunctions from '@/lib/firebase':", __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["functions"] ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["functions"].constructor.name : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["functions"]);
        ...
        if (sdkServicesInitialized) {
            ...
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["app"]) console.warn("[Page.tsx useEffect] firebaseApp from 'firebase.ts' is falsy or undefined.");
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"]) console.warn("[Page.tsx useEffect] storage from 'firebase.ts' is falsy or undefined.");
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["functions"]) console.warn("[Page.tsx useEffect] firebaseFunctions from 'firebase.ts' is falsy or undefined.");
    ...
    const renderPagePreviews = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        ...
        pages.forEach((pageCanvas, index)=>{
            ...
            previewDisplayCanvas.width = pageCanvas.width; // Use original canvas dimensions for buffer
            previewDisplayCanvas.height = pageCanvas.height;
            previewCtx.drawImage(pageCanvas, 0, 0); // Draw original canvas content
            ...
            wrapper.addEventListener('click', ()=>{
                ...
                } // If already selected, clicking again deselects (empty set)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isZoomModalOpen && zoomedPageData && zoomCanvasRef.current) {
            const canvas = zoomCanvasRef.current; // This is the TARGET canvas for zoom preview
            const ctx = canvas.getContext('2d');
            if (!ctx) return;
            const sourceCanvas = zoomedPageData.canvas; // This is the ORIGINAL page canvas
            const srcWidth = sourceCanvas.width;
            const srcHeight = sourceCanvas.height;
            // Determine target buffer dimensions based on rotation and zoomLevel
            let targetBufferWidth;
            let targetBufferHeight;
            ...
            // Translate to center of the target canvas and rotate
            ...
            ctx.drawImage(sourceCanvas, -canvas.width / 2, -canvas.height / 2, canvas.width, canvas.height // Draw the source image to fill the target canvas's height
            );
    ...
    const processPdfFile = async (file)=>{
        ...
        for(let i = 1; i <= numPages; i++){
            ...
            const viewport = page.getViewport({
                scale: 1.5
            }); // Adjust scale for preview quality
    ...
    const handlePdfUpload = async (event)=>{
        ...
        if ('dataTransfer' in event) {
            ...
            if (event.dataTransfer.files && event.dataTransfer.files.length > 0) {
                ...
                event.dataTransfer.clearData(); // Recommended for drag events
            }
        } else {
        ...
        setWordFileUrl(null); // Reset previous Word conversion URL
        setWordConversionError(null); // Reset previous Word conversion error
        setIsLoading(true);
        setLoadingMessage(texts.loadingPdf);
        try {
            const { canvases, docProxy } = await processPdfFile(file);
            setPages(canvases);
            setPdfDocumentProxy(docProxy); // Store PDFDocumentProxy
    ...
    const handleDeletePages = ()=>{
        ...
        setPages(newPages);
        setSelectedPages(new Set()); // Clear selection after deletion
    ...
    const handleDownloadPdf = async ()=>{
        ...
        try {
            ...
            for (let canvas of pages){
                const imgDataUrl = canvas.toDataURL('image/png'); // Use PNG for better quality
            ...
            if (pageNumberingConfig.enabled) {
                const font = await pdfDocOut.embedFont(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$StandardFonts$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["StandardFonts"].Helvetica); // Embed font for page numbers
                for(let i = 0; i < pdfLibPages.length; i++){
                    ...
                    const textHeight = font.heightAtSize(textSize); // This is full height (ascender + descender)
                    const margin = pageNumberingConfig.margin;
                    let x, y;
                    switch(pageNumberingConfig.position){
                        case 'top-left':
                            x = margin;
                            y = height - margin - font.ascender / font.unitsPerEm * textSize;
                            break;
                        case 'top-center':
                        ...
                        case 'bottom-left':
                            x = margin;
                            y = margin + font.descender / font.unitsPerEm * textSize;
                            break;
                        case 'bottom-center':
                            x = width / 2 - textWidth / 2;
                            y = margin + font.descender / font.unitsPerEm * textSize;
                        ...
                        default:
                            x = width / 2 - textWidth / 2;
                            y = margin + font.descender / font.unitsPerEm * textSize; // Default to bottom-center
                    }
            ...
            if (watermarkText.trim() !== '') {
                ...
                pdfLibPages.forEach((page)=>{
                    ...
                    page.drawText(watermarkText, {
                        ...
                        y: pageHeight / 2 - textHeight / 2 + helveticaFont.ascender / helveticaFont.unitsPerEm * watermarkFontSize,
                        font: helveticaFont,
                        size: watermarkFontSize,
                        color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$colors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["rgb"])(0.7, 0.7, 0.7),
                        opacity: 0.35,
                        rotate: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$rotations$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["degrees"])(45)
                    });
                });
            }
    ...
    const handleDownloadTxt = async ()=>{
        ...
        try {
            ...
            for(let i = 1; i <= pdfDocumentProxy.numPages; i++){
                ...
                const pageText = textContent.items.map((item)=>item.str).join(' '); // Basic text extraction
    ...
    const handleInsertPdfFileSelected = (event)=>{
        ...
        setPendingInsertFile(file); // Store file, wait for confirmation or direct insert
        if (pages.length > 0 && selectedPages.size === 0) {
            setIsInsertConfirmOpen(true); // Show confirmation dialog
        } else {
            proceedWithInsert(file); // Proceed directly if no PDF loaded or page selected
        }
    };
    const proceedWithInsert = async (fileToInsert)=>{
        const file = fileToInsert || pendingInsertFile; // Use passed file or pending file
        if (!file) return;
        setIsLoading(true);
        ...
        try {
            ...
            if (selectedPages.size > 0) {
                const firstSelected = Math.min(...Array.from(selectedPages)); // Get first selected page index
                insertIdx = insertPosition === 'before' ? firstSelected : firstSelected + 1;
            }
            const newPages = [
                ...pages
            ];
            newPages.splice(insertIdx, 0, ...insertCanvases); // Insert new canvases
            setPages(newPages);
            // Select the first of the newly inserted pages
            const newSelected = new Set();
            ...
            setIsLoading(false);
            setLoadingMessage('');
            setPendingInsertFile(null); // Clear pending file
    ...
    const handleConvertToWord = async ()=>{
        ...
        if (!isFirebaseSystemReady || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["storage"] || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["functions"]) {
            // Use the specific warning message which might contain details about missing env vars
            toast({
                title: texts.wordConvertError,
        ...
        setWordFileUrl(null); // Reset previous URL
        setWordConversionError(null); // Reset previous error
        // Guest conversion limit check
        if ("TURBOPACK compile-time falsy", 0) {
            "TURBOPACK unreachable";
        // Note: Count increment is moved to after successful conversion or within the try block's success path
        }
        ...
        try {
            ...
            // IMPORTANT: Replace with your actual Firebase Function URL or setup callable functions
            const functionUrl = `https://us-central1-sitemate-otkpt.cloudfunctions.net/convertPdfToWord`; // Example, update this
            ...
            if (!response.ok) {
                ...
                try {
                    ...
                    // If not JSON, use text. This can happen for various errors like CORS, network issues, or non-JSON error strings from the function.
                    const errorText = await response.text();
                    errorData = {
                        detail: errorText || response.statusText
                    }; // Fallback to statusText if text is empty
                }
                // For logging, ensure errorData isn't an empty object, which can be unhelpful
                ...
                // Specific check for PDF.co "Method Not Found" or API key issues, which might be returned in 'detail'
                ...
                throw new Error(detailMessage); // Throw to be caught by the catch block below
            }
            ...
            // Increment guest conversion count only on success
            if ("TURBOPACK compile-time falsy", 0) {
                "TURBOPACK unreachable";
            }
        } catch (error) {
            ...
            // Refine error message for PDF.co specific issues from the caught error
            if (typeof errMsg === 'string' && (errMsg.toLowerCase().includes("method not found") || errMsg.toLowerCase().includes("api key") || errMsg.toLowerCase().includes("please provide your api key"))) {
                ...
                // This specific string might be from your Cloud Function's error handling
    ...
    const commonDragEvents = {
        onDragOver: (e)=>{
            ...
            e.stopPropagation();
            e.currentTarget.classList.add('border-primary', 'bg-primary/10'); // Visual feedback
        },
        onDragLeave: (e)=>{
            e.preventDefault();
            e.stopPropagation();
            e.currentTarget.classList.remove('border-primary', 'bg-primary/10'); // Remove visual feedback
        },
        onDrop: (e, handler)=>{
            e.preventDefault();
            e.stopPropagation();
            e.currentTarget.classList.remove('border-primary', 'bg-primary/10'); // Remove visual feedback
            handler(e); // Call the appropriate upload/insert handler
        }
    };
    ...
    const closeZoomModal = ()=>{
        ...
        setZoomedPageData(null); // Clear zoomed page data
        setCurrentRotation(0); // Reset rotation for next zoom
        setZoomLevel(1); // Reset zoom level
    };
    const ZOOM_SPEED = 0.1; // Controls how much zoom changes per wheel tick
    const MIN_ZOOM = 0.1; // Minimum zoom level (10%)
    const MAX_ZOOM = 5; // Maximum zoom level (500%)
    const handleWheel = (event)=>{
        if (!isZoomModalOpen || !zoomedPageData) return; // Only zoom if modal is open and data exists
        event.preventDefault(); // Prevent page scroll
        // Calculate zoom direction and amount
        const zoomAmount = -event.deltaY * ZOOM_SPEED * 0.01; // Adjust multiplier for sensitivity
        setZoomLevel((prevZoomLevel)=>{
            let newZoomLevel = prevZoomLevel + zoomAmount;
            newZoomLevel = Math.max(MIN_ZOOM, Math.min(newZoomLevel, MAX_ZOOM)); // Clamp between min/max
            return newZoomLevel;
        });
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            (isLoading || isDownloading || isExtractingText || isConvertingToWord) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            isZoomModalOpen && zoomedPageData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                role: "dialog",
                "aria-modal": "true",
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                        children: [
                                                            ...
                                                            pages.length,
                                                            " ",
                                                            pages.length === 1 ? texts.page.toLowerCase() : currentLanguage === 'zh' ? texts.pagesLoaded.replace('頁已載入。', '頁') : texts.pagesLoaded.replace('pages loaded.', 'page(s)'),
                                                            " ",
                                                            currentLanguage === 'zh' ? '已載入' : 'loaded',
                                                            ". ",
                                                            selectedPages.size > 0 ? `${texts.page} ${Array.from(selectedPages)[0] + 1} ${currentLanguage === 'zh' ? texts.pageSelected.replace('頁已選取。', '') : texts.pageSelected.replace('page selected.', '')}` : '',
                                                            " "
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/src/app/page.tsx",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__29856f07._.js.map