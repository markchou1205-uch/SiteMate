            ...
            <div className="w-full max-w-4xl space-y-8">
                <Card className="w-full">
                  <CardHeader className="text-center">
                      ...
                      <CardTitle>{texts.htmlToPdfTitle}</CardTitle>
                      <CardDescription>{texts.htmlToPdfDescription}</CardDescription>
                  </CardHeader>
                  <CardContent>
                        ...
                        <MenubarContent>
                            <MenubarSub>
                                ...
                                <MenubarSubContent>
                                    ...
                                    <MenubarItem onClick={() => router.push('/html-to-pdf')} disabled><Code className="mr-2 h-4 w-4" />{texts.htmlToPdfTitle}</MenubarItem>
