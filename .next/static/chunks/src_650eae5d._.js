    ...
    const handleStyleChange = (style)=>{
        ...
        if (start === end) {
            ...
            for (const segment of annotation.segments){
                ...
                if (segmentEnd <= start || segmentStart >= end) {
                    ...
                    newSegments.push({
                        ...segment,
                        ...style,
                        text: segment.text.slice(Math.max(0, start - segmentStart), Math.min(segment.text.length, end - segmentStart))
                    });
                    if (segmentEnd > end) {
                        newSegments.push({
                            ...segment,
            ...
            for (const segment of newSegments){
                if (lastSegment && lastSegment.color === segment.color && lastSegment.bold === segment.bold && lastSegment.italic === segment.italic && lastSegment.underline === segment.underline) {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$popover$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PopoverTrigger"], {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                style: {
                                    backgroundColor: annotation.segments[0]?.color || '#000000'
                                }
                            }, void 0, false, {
                                fileName: "[project]/src/app/edit-pdf/page.tsx",
                                lineNumber: 204,
...
_s(TextAnnotationToolbar, "gJtT2aPnbUb4WH8ANBrFCKASbhs=");
_c = TextAnnotationToolbar;
    ...
    const handleTextChange = (e)=>{
        ...
        for (const segment of oldSegments){
            ...
            if (segmentEnd <= start || segmentStart >= end) {
                newSegments.push({
                    ...segment,
                    text: fullText.slice(segmentStart, segmentEnd)
                });
            } else {
                if (segmentStart < start) {
                    newSegments.push({
...
_c1 = TextAnnotationComponent;
function PdfEditor() {
    _s2();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const [currentLanguage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('zh');
    ...
    const saveStateToHistory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "PdfEditor.useCallback[saveStateToHistory]": ()=>{
    ...
    const onAnnotationChange = (id, updates)=>{
        setAnnotations(annotations.map((ann)=>ann.id === id ? {
                ...ann,
                ...updates
            } : ann));
        saveStateToHistory();
    ...
    const onSelectAnnotation = (e, id)=>{
        e.stopPropagation();
        setSelectedAnnotationId(id);
        setInteractionMode('selected');
    };
    const onEditAnnotation = (e, id)=>{
        e.stopPropagation();
        setSelectedAnnotationId(id);
        setInteractionMode('editing');
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PdfEditor.useEffect": ()=>{
            ...
            if (container) {
                ...
                return ({
                    "PdfEditor.useEffect": ()=>container.removeEventListener('wheel', handleWheel)
                })["PdfEditor.useEffect"];
            }
        }
    }["PdfEditor.useEffect"], []);
    const renderPage = ()=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                annotations.filter((ann)=>ann.pageIndex === activePageIndex).map((ann)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TextAnnotationComponent, {
                        annotation: ann,
                ...
                selectedAnnotationId && interactionMode === 'editing' && annotations.find((ann)=>ann.id === selectedAnnotationId)?.type === 'text' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "absolute top-0 left-0 w-full pointer-events-none",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TextAnnotationToolbar, {
                        annotation: annotations.find((ann)=>ann.id === selectedAnnotationId),
                        onAnnotationChange: onAnnotationChange,
    ...
    const handleFileUpload = async (e)=>{
        ...
        try {
            ...
            const pdfDoc = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdfjs$2d$dist$2f$build$2f$pdf$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocument"])(arrayBuffer).promise;
            ...
            toast({
                title: "PDF 載入成功",
                description: `${pdfDoc.numPages} 頁已載入`
            });
        } catch (error) {
            toast({
                variant: "destructive",
                title: "PDF載入失敗",
                description: "請檢查檔案格式並重試"
            });
        } finally{
            setIsLoading(false);
        }
...
_s2(PdfEditor, "b2dYMBE9sJqUvsZG7WhU5J83RG0=", false, function() {
    return [
...
_c2 = PdfEditor;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "TextAnnotationToolbar");
__turbopack_context__.k.register(_c1, "TextAnnotationComponent");
__turbopack_context__.k.register(_c2, "PdfEditor");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_650eae5d._.js.map